class NeuralNetworkController < ApplicationController
  ...
  def compare_websites_update
    ...
    # system "lib/fann-master/wc2fann/webComp"

    # Call the neural network
    system "lib/fann-master/wc2fann/web_comp_test"
  ...
  def show_websites
    ...
    file = File.open("./lib/fann-master/wc2fann/Web_Comp_Answer.txt", "r+")
  ...
  def train_update
    ...
    system "lib/fann-master/wc2fann/web_comp_train {params[:best_image]}"
